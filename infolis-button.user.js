...
// @name         Infolis Button
// @namespace    kba
// @version      0.2016-08-18T15:37:09+02:00
...
var BUTTON_DATA_API, CONFIG_CSS, CONFIG_FRAME_STYLE, SCOPED_CSS, SCRIPT_ID, ZOTERO_API;
...
GM_config.init({
  ...
  events: {
    open: function(configDocument, configWindow) {
      ...
      return DOLLAR('#empty-zotero-cache').on('click tap', function() {
        return GM_xmlhttpRequest({
          method: 'DELETE',
          url: ZOTERO_API + '/cache',
          onload: function(response) {
            return console.warn("Emptied Zotero Cache", response);
          }
        });
      });
    }
